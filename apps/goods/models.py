...
class IndexTypeGoodsBanner(BaseModel):
    ...
    class Meta:
        db_table = 'myshop_index_type_goods'
...
class IndexPromotionBanner(BaseModel):
    ...
    class Meta:
        db_table = 'myshop_index_promotion'
        verbose_name = "主页促销活动"
        verbose_name_plural = verbose_name